...
@Component({
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div
                        class="div__column_with_full_name_of_employees"
                    >
                    ...
                    <div
                        class="div__the_column_with_the_cabinet_number"
                    >
                        <div class="div__wrapping_h3" >
                            <h3>Каб</h3>
                        </div>
                    ...
                    <div
                        class="div__column_with_the_name_and_type_of_equipment"
                    >
                        <div class="div__wrapping_h3" >
                            <h3>Техника</h3>
                        </div>
                ...
                >
                @for ( employees_technique of a_visible_list_of_the_satellite_component; track $index ) {
                        <div
                        ...
                        >
                            <div
                                class="div__the_auto_numbering_column"
                            >
                                <h3>{{ employees_technique.id }}</h3>
                                <div class="div__decorative_division_No_1" ></div>
                            </div>
                            <div
                                class="div__column_with_full_name_of_employees"
                            >
                                <h3>{{ employees_technique.fcs }}</h3>
                                <div class="div__decorative_division_No_2" ></div>
                            </div>
                            <div
                                class="div__the_column_with_the_cabinet_number"
                            >
                                <h3>{{ employees_technique.office }}</h3>
                                <div class="div__decorative_division_No_3" ></div>
                            </div>
                            <div
                                class="div__column_with_the_name_and_type_of_equipment"
                            >
                                <h3>{{ employees_technique.type }} / {{ employees_technique.name }}</h3>
                            </div>
                            <div
                                class="div__column_with_delete_button"
                            >
                                <button (click)="removingTheEmployeeTechnicianBundle($index)">
                            ...
                            >
                                <button (click)="editingTheEmployeeTechnicianBundle($index)">
            ...
            <!-- <table>
                ...
                <tbody>
                    @for ( employees_technique of a_visible_list_of_the_satellite_component; track employees_technique.id ) {
                        <tr>
                            <th>{{ employees_technique.id }}</th>
                            <th>{{ employees_technique.fcs }}</th>
                            <th>{{ employees_technique.office }}</th>
                            <th>{{ employees_technique.type }} / {{ employees_technique.name }}</th>
                            <th>
                                <button (click)="removingTheEmployeeTechnicianBundle(employees_technique.id)">
                                    <img ngSrc="minus.svg" width="20" height="20" alt="" />
                                </button>
                            </th>
                            <th>
                            <button (click)="editingTheEmployeeTechnicianBundle(employees_technique.id)">
                                    <img ngSrc="pen.svg" width="20" height="20" alt="" />
                                </button>
                            </th>
                        </tr>
    ...
    styles: `
        ...
        .div__table_header .div__column_with_full_name_of_employees {
            width: 100%;
            display: flex;
            align-items: center;
            flex: 0 0 386px;
        }
        .div__table_header .div__column_with_full_name_of_employees .div__wrapping_h3 {
            width: 100%;
            height: 100%;
            display: flex;
            align-items: center;
        ...
        .div__table_header .div__column_with_full_name_of_employees .div__wrapping_h3 h3 {
            font-family: "Inter", sans-serif;
            font-size: 14px;
            font-weight: 400;
            font-style: normal;
        ...
        .div__table_header .div__column_with_full_name_of_employees .div__decorative_division_No_2 {
            width: 1px;
            height: 20px;
            background-color: rgba(89,110,189,0.3);
        }

        .div__table_header .div__the_column_with_the_cabinet_number {
            width: 100%;
            display: flex;
            align-items: center;
            flex: 0 0 100px;
        }
        .div__table_header .div__the_column_with_the_cabinet_number .div__wrapping_h3 {
            width: 100%;
            height: 100%;
            display: flex;
            align-items: center;
        ...
        .div__table_header .div__the_column_with_the_cabinet_number .div__wrapping_h3 h3 {
            font-family: "Inter", sans-serif;
            font-size: 14px;
            font-weight: 400;
            font-style: normal;
        ...
        .div__table_header .div__the_column_with_the_cabinet_number .div__decorative_division_No_3 {
            width: 1px;
            height: 20px;
            background-color: rgba(89,110,189,0.3);
        }

        .div__table_header .div__column_with_the_name_and_type_of_equipment {
            width: 100%;
            display: flex;
            align-items: center;
            flex: 0 0 100px;
        }
        .div__table_header .div__column_with_the_name_and_type_of_equipment .div__wrapping_h3 {
            width: 100%;
            height: 100%;
            display: flex;
            align-items: center;
        ...
        .div__table_header .div__column_with_the_name_and_type_of_equipment .div__wrapping_h3 h3 {
            font-family: "Inter", sans-serif;
            font-size: 14px;
            font-weight: 400;
            font-style: normal;
        ...
        .div__table_row .div__column_with_full_name_of_employees {
            display: flex;
            align-items: center;
            flex: 0 0 400px;
        }
        .div__table_row .div__column_with_full_name_of_employees h3 {
            font-family: "Inter", sans-serif;
            font-size: 14px;
            font-weight: 400;
            font-style: normal;
        ...
        .div__table_row .div__column_with_full_name_of_employees .div__decorative_division_No_2 {
            width: 1px;
            height: 20px;
            background-color: rgba(255,255,255,0.3);
            margin-left: auto;
        ...
        .div__table_row .div__the_column_with_the_cabinet_number {
            display: flex;
            align-items: center;
            flex: 0 0 100px;
        }
        .div__table_row .div__the_column_with_the_cabinet_number h3 {
            font-family: "Inter", sans-serif;
            font-size: 14px;
            font-weight: 400;
            font-style: normal;
        ...
        .div__table_row .div__the_column_with_the_cabinet_number .div__decorative_division_No_3 {
            width: 1px;
            height: 20px;
            background-color: rgba(255,255,255,0.3);
            margin-left: auto;
        ...
        .div__table_row .div__column_with_the_name_and_type_of_equipment {
            display: flex;
            align-items: center;
            flex: 0 0 250px;
            margin-right: auto;
        }
        .div__table_row .div__column_with_the_name_and_type_of_equipment h3 {
            font-family: "Inter", sans-serif;
            font-size: 14px;
            font-weight: 400;
            font-style: normal;
...
export class EmployeeEquipment implements OnInit {
    ...
    performingASearchByAGivenValue() {
        ...
        let found_people = this.a_visible_list_of_the_satellite_component.filter((obj: any) => {
            ...
            if (obj.technic.includes(this.the_value_of_the_search_string)) {
                return obj;
            }
        });
    ...
    removingTheEmployeeTechnicianBundle(employee_technician_bundle_index: number) {
        try {
            ...
            xhr.onload = () => {
                if (xhr.status == 200) {
                    this.CHTSS.dataOnTheRemovalOfTheEmployeeTechnicianBundle.next({
                        name: this.a_visible_list_of_the_satellite_component[employee_technician_bundle_index].name,
                        fcs: this.a_visible_list_of_the_satellite_component[employee_technician_bundle_index].fcs
                    });
                }
            };
        } catch (error) {
