...
@Component({
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div
                        class="div__column_with_names_of_types_of_equipment"
                    >
                ...
                >
                @for ( type_of_equipment of a_visible_list_of_the_satellite_component; track $index ) {
                        <div
                        ...
                        >
                            <div
                                class="div__the_auto_numbering_column"
                            >
                                <h3>{{ type_of_equipment.id }}</h3>
                                <div class="div__decorative_division_No_1" ></div>
                            </div>
                            <div
                                class="div__column_with_names_of_equipment"
                            >
                                <h3>{{ type_of_equipment.type }}</h3>
                                <div class="div__decorative_division_No_2" ></div>
                            </div>
                            <div
                                class="div__column_with_delete_button"
                            >
                                <button (click)="removingATypeOfEquipment($index)">
                            ...
                            >
                                <button (click)="editingEquipmentTypeData($index)">
            ...
            <!-- <table>
                ...
                <tbody>
                    @for ( type_of_equipment of a_visible_list_of_the_satellite_component; track type_of_equipment.id ) {
                        <tr>
                            <th>{{ type_of_equipment.id }}</th>
                            <th>{{ type_of_equipment.type }}</th>
                            <th>
                                <button (click)="removingATypeOfEquipment(type_of_equipment.id)">
                                    <img ngSrc="minus.svg" width="20" height="20" alt="" />
                                </button>
                            </th>
                            <th>
                            <button (click)="editingEquipmentTypeData(type_of_equipment.id)">
                                    <img ngSrc="pen.svg" width="20" height="20" alt="" />
                                </button>
                            </th>
                        </tr>
    ...
    styles: `
        ...
        .div__table_header .div__column_with_names_of_types_of_equipment {
            width: 100%;
            display: flex;
            align-items: center;
            flex: 0 0 780px;
        }
        .div__table_header .div__column_with_names_of_types_of_equipment .div__wrapping_h3 {
            width: 100%;
            height: 100%;
            display: flex;
            align-items: center;
        ...
        .div__table_header .div__column_with_names_of_types_of_equipment .div__wrapping_h3 h3 {
            font-family: "Inter", sans-serif;
            font-size: 14px;
            font-weight: 400;
            font-style: normal;
        ...
        .div__table_header .div__column_with_names_of_types_of_equipment .div__decorative_division_No_2 {
            width: 1px;
            height: 20px;
            background-color: rgba(89,110,189,0.3);
        }
        ...
        .div__table_row .div__column_with_names_of_equipment .div__decorative_division_No_2 {
            width: 1px;
            height: 20px;
            background-color: rgba(255,255,255,0.3);
            margin-left: auto;
...
export class TypeOfEquipment implements OnInit {
    ...
    removingATypeOfEquipment(type_of_equipment_index: number) {
        try {
            ...
            xhr.onload = () => {
                if (xhr.status == 200) {
                    this.CHTSS.dataOnTheRemovalOfTheTypeOfEquipment.next(this.a_visible_list_of_the_satellite_component[type_of_equipment_index].type);
                }
            };
        } catch (error) {
            console.log(error);
